    ...
    const fetchSettings = async () => {
        try {
            ...
            if (role === 'filial' && selectedFilial) {
                allSettings = await getFilialSettings(selectedFilial);
            } else {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (videoLink !== '' || chinaAddress !== '' || whatsappNumber !== '' || aboutUsText !== '' || prohibitedItemsText !== '' || contractFile !== '') {
                let response;
                if (role === 'filial' && selectedFilial) {
                    response = await updateFilialSettings(selectedFilial, videoLink, chinaAddress, whatsappNumber, aboutUsText, prohibitedItemsText, contractFile);
                } else {
